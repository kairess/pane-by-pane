...
const ko = {
  ...
  ctl: [
    '빈 칸 탭: 새 구역 시작 (색 자동)',
    '칸 드래그: 지나간 칸을 같은 구역으로 잇기 (경계선은 못 넘음). 다른 색 구역에 닿으면 그 구역 전체가 현재 색으로 합쳐짐',
    '칠한 칸 탭: 그 칸 지우기 · 칠한 칸에서 드래그: 그 색으로 잇기',
    '지우개 버튼: 드래그로 여러 칸 지우기 (경계선은 다시 탭해서 지움)',
    '칸 사이 경계 탭: 경계선 그리기 / 다시 탭하면 지우기 (손을 뗄 때 적용, 경계에서 드래그하면 칠하기)',
    '칸 길게 누르기: 그 구역의 넓이',
  ...
  completeBorders: '창이 완성되었습니다 ✦ (경계선)',
  completePaint: '창이 완성되었습니다 ✦ (색유리)',
...
const en: typeof ko = {
  ...
  controls: 'Controls',
  ctl: [
    'Tap an empty cell: start a new region (colour picked for you)',
    'Drag across cells: join them into one region (never across a border). Touching a region of another colour merges it into the current one',
    'Tap a painted cell: clear it · drag from a painted cell: extend that colour',
    'Eraser: drag to clear several cells (borders are removed by tapping them)',
    'Tap between two cells: draw a border / tap again to remove (applied on release; dragging from a border paints instead)',
    'Long-press a cell: show the area of its region',
  ...
  completeBorders: 'The window is complete ✦ (borders)',
  completePaint: 'The window is complete ✦ (glass)',
