...
> **검증 메모(2026-09-22, `A_RULES.md`):** 원작의 Solitude는 기호 종류를 가리지 않고 **다른 규칙의 단서 타일(넓이의 수·폴리오미노·울타리 등)을 포함해 구역마다 기호가 정확히 하나**인 규칙이며, 단독으로도 장미창과도 나오지 않습니다. 아래의 `●   ●` 예시는 "기호가 한 종류뿐인 장미창"에 해당합니다.
